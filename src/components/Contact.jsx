...
const contactLinks = [
  ...
  },
  {
    ...
    label: 'Phone', value: personalInfo.phone, href: `tel:+16473252998`,
  },
  {
    icon: (
    ...
    label: 'WhatsApp', value: '+1 647-325-2998', href: 'https://wa.me/16473252998',
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    label: 'LinkedIn', value: 'jahangir-ali2998', href: personalInfo.linkedin,
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
export default function Contact({ darkMode = true }) {
  ...
  return (
    <section id="contact" className="relative z-10 py-28 px-8 md:px-16 max-w-6xl mx-auto">
      <div className="mb-14">
        <p className={`font-mono text-xs tracking-[0.3em] uppercase mb-3 ${darkMode ? 'text-[#C9A84C]/60' : 'text-[#C9A84C]/80'}`}>06 — Get In Touch</p>
