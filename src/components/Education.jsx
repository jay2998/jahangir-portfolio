...
export default function Education({ darkMode = true }) {
  return (
    <section id="education" className={`relative z-10 py-28 scroll-mt-24 ${darkMode ? '' : 'bg-[#F9F7F3]'}`}>
      <div className="px-8 md:px-16 max-w-6xl mx-auto">
      <div className="mb-14">
        <p className={`font-mono text-xs tracking-[0.3em] uppercase mb-3 ${darkMode ? 'text-[#C9A84C]/60' : 'text-[#C9A84C]/80'}`}>05 — Academic Background</p>
